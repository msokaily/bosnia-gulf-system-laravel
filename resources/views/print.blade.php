...
<head>
    ...
    <style type="text/css">
        ...
        ol.lst-kix_list_22-3.start {
            counter-reset: lst-ctn-kix_list_22-3 -1
        }
        ...
        ol.lst-kix_list_24-6.start {
            counter-reset: lst-ctn-kix_list_24-6 -1
        }
        ...
        ol.lst-kix_list_24-1.start {
            counter-reset: lst-ctn-kix_list_24-1 -1
        }
        ...
        ol.lst-kix_list_22-8.start {
            counter-reset: lst-ctn-kix_list_22-8 -1
        }

        ol.lst-kix_list_22-5.start {
            counter-reset: lst-ctn-kix_list_22-5 -1
        }
        ...
        ol.lst-kix_list_24-4.start {
            counter-reset: lst-ctn-kix_list_24-4 -1
        }
        ...
        ol.lst-kix_list_24-5.start {
            counter-reset: lst-ctn-kix_list_24-5 -1
        }
        ...
        ol.lst-kix_list_22-4.start {
            counter-reset: lst-ctn-kix_list_22-4 -1
        }
        ...
        ol.lst-kix_list_24-3.start {
            counter-reset: lst-ctn-kix_list_24-3 -1
        }
        ...
        ol.lst-kix_list_22-7.start {
            counter-reset: lst-ctn-kix_list_22-7 -1
        }
        ...
        ol.lst-kix_list_24-2.start {
            counter-reset: lst-ctn-kix_list_24-2 -1
        }

        ol.lst-kix_list_22-6.start {
            counter-reset: lst-ctn-kix_list_22-6 -1
        }
        ...
        ol.lst-kix_list_24-8.start {
            counter-reset: lst-ctn-kix_list_24-8 -1
        }
        ...
        ol.lst-kix_list_22-2.start {
            counter-reset: lst-ctn-kix_list_22-2 -1
        }
        ...
        ol.lst-kix_list_24-7.start {
            counter-reset: lst-ctn-kix_list_24-7 -1
        }
...
<body class="c4 doc-content" style="position: relative;">
    ...
    <p class="c5 c7"><span class="c17"></span></p>
    <p class="c1 c7"><span class="c17"></span></p>
    <p class="c10"><span class="c17">CLIENT: {{$order->name}}</span></p>
    <p class="c10" id="h.gjdgxs"><span class="c0">PERIOD OF STAYING: {{ \Carbon\Carbon::parse($order->arrive_at)->format('d/m/Y')}} &ndash; &nbsp;{{\Carbon\Carbon::parse($order->leave_at)->format('d/m/Y')}}</span></p>
    <p class="c1 c7" id="h.30j0zll"><span class="c0"></span></p>
    ...
    <p class="c1 c7 c11"><span class="c0"></span></p>
    <p class="c1 c7 c11"><span class="c0"></span></p>
    <p class="c1"><span class="c0">TOTAL PRICE = {{number_format((($order->total_special > 0 ? $order->total_special : $order->total)/* - ($down_payment ?? 0)*/) ?? 0, 2)}} &euro; </span></p>
    ...
    <p class="c1"><span class="c12 c15">PAYMENT IN CASH = {{number_format((($order->total_special > 0 ? $order->total_special : $order->total) + ($deposit ?? 0) - ($order->paid_eur ?? 0)), 2)}} &euro; &nbsp;</span><span class="c12">&nbsp;</span></p>
